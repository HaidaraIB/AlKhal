              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  value: _unitController.text.isNotEmpty
                      ...
                      : null,
                  onChanged: (value) {
                    setState(() => _unitController.text = value!.toString());
                  },
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    if (value!.isEmpty) {
                      ...
                      return 'الرجاء إدخال رقم';
                    } else if (double.tryParse(_sellingPriceController.text) !=
                            null &&
                ...
                TextFormField(
                  ...
                  keyboardType: TextInputType.number,
                  decoration: const InputDecoration(labelText: 'سعر المبيع'),
                  validator: (value) {
                    if (value!.isEmpty) {
                      return 'الرجاء إدخال سعر مبيع';
                    } else if (double.tryParse(value) == null) {
                      return 'الرجاء إدخال رقم';
                    } else if (double.tryParse(_purchasePriceController.text) !=
                            null &&
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      final newItem = Item(
                        ...
                        unit: MeasurementUnit.fromString(_unitController.text),
                      ...
                      BlocProvider.of<ItemCubit>(context).addItem(newItem);
